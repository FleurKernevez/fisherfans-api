 ...
 */
module.exports.getBoatTrip = function getBoatTrip (
  req, 
  res, 
  next, 
  user_id, 
 ...
 */
module.exports.updateBoatTrip = function updateBoatTrip (
  req, 
  res, 
  next, 
  id, 
 ...
 * Fonction pour mettre à jour les données d'un voyage en bateau
 */
module.exports.updateBoatTrip_1 = function updateBoatTrip_1 (
  req, 
  res, 
  next, 
  id, 
